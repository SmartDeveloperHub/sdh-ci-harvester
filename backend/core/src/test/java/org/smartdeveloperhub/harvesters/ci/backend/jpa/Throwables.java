...
public final class Throwables {
	...
	public static <T extends Throwable> T findCause(final Exception e, final Class<? extends T> causeClass) {
		Throwable failure=e;
		while(failure!=null) {
			if(causeClass.isInstance(failure)) {
				return causeClass.cast(failure);
			} else {
