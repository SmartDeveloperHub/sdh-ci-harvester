...
public class DerbyProvider implements DatabaseProvider {
	...
	@Override
	public Database create(DatabaseConfig config) throws DatabaseLifecycleException {
		final EntityManagerFactory factory = Persistence.createEntityManagerFactory("itTestsDerby");
		return new Database() {
